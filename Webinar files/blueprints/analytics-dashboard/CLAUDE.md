...
```javascript
const APIFY_TOKEN = 'apify_api_nvBM1rZf8kqCj1WlAPlDNLPyVbuH4O16a4KF';
...
- API key satırı kodda açıkça görünecek: `const APIFY_TOKEN = 'apify_api_nvBM1rZf8kqCj1WlAPlDNLPyVbuH4O16a4KF'`
